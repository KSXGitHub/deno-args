...
testOk('positive float with positive exponent', ['--flag', '1.2e3'], { flag: 1.2e3 })
testOk('positive float with negative exponent', ['--flag', '1.2e-3'], { flag: 1.2e-3 })
testOk('negative float with positive exponent', ['--flag', '-3.2e1'], { flag: -3.2e1 })
testOk('negative float with negative exponent', ['--flag', '-3.2e-1'], { flag: -3.2e-1 })
...
testErr(
  'not a valid number', ['--flag', 'blah blah blah'],
  ['ValueParsingFailure'], 'Failed to parse --flag: Not a number: blah blah blah'
)
testErr(
  'NaN', ['--flag', 'NaN'],
  ['ValueParsingFailure'], 'Failed to parse --flag: Not a number: NaN'
)
testErr(
  'Infinity', ['--flag', 'Infinity'],
  ['ValueParsingFailure'], 'Failed to parse --flag: Not a number: Infinity'
)
testErr(
  '-Infinity', ['--flag', '-Infinity'],
  ['ValueParsingFailure'], 'Failed to parse --flag: Not a number: -Infinity'
